...
%post
[ -e %{_infodir}/automake.info.gz ] && /sbin/install-info %{_infodir}/automake.info.gz %{_infodir}/dir || :

%preun
if [ $1 = 0 ]; then
    [ -e %{_infodir}/automake.info.gz ] && /sbin/install-info --delete %{_infodir}/automake.info.gz %{_infodir}/dir || :
fi
